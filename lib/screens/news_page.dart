...
final List<Map<String, dynamic>> _dummyPage1 = [
  ...
  {
    'news_id': 214750,
    'title': 'SK하이닉스, 2분기 HBM 공급 확대… 영업이익 사상 최대 전망',
    'summary': 'SK하이닉스가 2분기 HBM 공급을 대폭 확대하며 영업이익 사상 최대치를 기록할 것으로 시장이 전망하고 있다.',
    'pub_date': '2026-03-11T09:00:00',
    'path': 'A1',
    'stock_name': 'SK하이닉스',
    'stock_change': '+7.2%',
    'stock_up': true,
  ...
  {
    'news_id': 214700,
    'title': '현대차, 전기차 신모델 출시… 테슬라와 정면 승부',
    'summary': '현대자동차가 새로운 전기차 모델을 출시하며 글로벌 시장에서 테슬라와 본격적인 경쟁에 나선다.',
    'pub_date': '2026-03-10T10:30:00',
    'path': 'A1',
    'stock_name': '현대차',
    'stock_change': '+2.8%',
    'stock_up': true,
  ...
  {
    'news_id': 214600,
    'title': '카카오뱅크, 대출 금리 인하… 시중은행과 경쟁 심화',
    'summary': '카카오뱅크가 주요 대출 금리를 인하하며 시중은행과의 경쟁이 더욱 치열해질 전망이다.',
    'pub_date': '2026-03-08T09:30:00',
    'path': 'A2',
    'stock_name': '카카오뱅크',
    'stock_change': '-0.5%',
    'stock_up': false,
  ...
  {
    'news_id': 214550,
    'title': 'LG에너지솔루션, GM과 배터리 합작 법인 추가 투자 결정',
    'summary': 'LG에너지솔루션이 GM과의 배터리 합작 법인에 추가 투자를 결정하며 북미 전기차 배터리 시장 공략을 강화한다.',
    'pub_date': '2026-03-07T13:00:00',
    'path': 'A1',
    'stock_name': 'LG에너지솔루션',
    'stock_change': '+3.5%',
    'stock_up': true,
  ...
  {
    'news_id': 214500,
    'title': '네이버, 생성형 AI 서비스 월간 활성 사용자 1000만 돌파',
    'summary': '네이버의 생성형 AI 서비스 클로바X가 출시 6개월 만에 월간 활성 사용자 1000만 명을 돌파했다.',
    'pub_date': '2026-03-06T10:00:00',
    'path': 'A1',
    'stock_name': '네이버',
    'stock_change': '+1.9%',
    'stock_up': true,
  ...
  {
    'news_id': 214450,
    'title': '두산에너빌리티, 소형모듈원전 수주 기대감에 주가 급등',
    'summary': '두산에너빌리티가 미국 SMR 프로젝트 수주 기대감으로 주가가 크게 상승하며 시장의 주목을 받고 있다.',
    'pub_date': '2026-03-05T14:30:00',
    'path': 'A1',
    'stock_name': '두산에너빌리티',
    'stock_change': '+8.2%',
    'stock_up': true,
  ...
  {
    'news_id': 214400,
    'title': '삼성바이오로직스, 글로벌 제약사 위탁생산 계약 체결',
    'summary': '삼성바이오로직스가 글로벌 주요 제약사와 대규모 바이오의약품 위탁생산 계약을 체결했다고 공시했다.',
    'pub_date': '2026-03-04T09:00:00',
    'path': 'A1',
    'stock_name': '삼성바이오로직스',
    'stock_change': '+2.3%',
    'stock_up': true,
  ...
  {
    'news_id': 214350,
    'title': '한국전력, 전기요금 추가 인상 검토… 적자 해소 총력',
    'summary': '한국전력이 누적 적자 해소를 위해 추가적인 전기요금 인상을 검토 중인 것으로 알려졌다.',
    'pub_date': '2026-03-03T11:30:00',
    'path': 'A2',
    'stock_name': '한국전력',
    'stock_change': '-1.8%',
    'stock_up': false,
  ...
  {
    'news_id': 214250,
    'title': 'KB금융, 자사주 매입 소각 확대… 주주환원 강화',
    'summary': 'KB금융그룹이 자사주 매입 및 소각 규모를 확대하며 주주환원 정책을 한층 강화하기로 결정했다.',
    'pub_date': '2026-03-01T10:00:00',
    'path': 'A1',
    'stock_name': 'KB금융',
    'stock_change': '+2.0%',
    'stock_up': true,
  ...
  {
    'news_id': 214200,
    'title': '크래프톤, 신작 게임 글로벌 출시… 배그 흥행 이을까',
    'summary': '크래프톤이 새로운 배틀로얄 장르 게임을 글로벌 시장에 출시하며 배틀그라운드의 흥행을 이을 수 있을지 주목된다.',
    'pub_date': '2026-02-28T13:00:00',
    'path': 'A1',
    'stock_name': '크래프톤',
    'stock_change': '+5.7%',
    'stock_up': true,
  ...
  {
    'news_id': 214150,
    'title': '코스피, 외국인 순매수에 2600선 회복… 반도체주 강세',
    'summary': '코스피 지수가 외국인의 대규모 순매수에 힘입어 2600선을 회복하며 반도체 관련 주식들이 강세를 보였다.',
    'pub_date': '2026-02-27T16:00:00',
    'path': 'A1',
    'stock_name': '삼성전자',
    'stock_change': '+1.8%',
    'stock_up': true,
...
final List<Map<String, dynamic>> _dummyPage2 = [
  ...
  {
    'news_id': 214050,
    'title': '하이브, 새 아티스트 데뷔로 주가 상승 기대',
    'summary': '하이브가 새로운 아이돌 그룹 데뷔를 앞두고 글로벌 팬덤 형성에 주력하며 엔터테인먼트 시장 공략을 강화하고 있다.',
    'pub_date': '2026-02-25T09:00:00',
    'path': 'A1',
    'stock_name': '하이브',
    'stock_change': '+4.2%',
    'stock_up': true,
  ...
  {
    'news_id': 213950,
    'title': '카카오게임즈, 신작 RPG 사전예약 100만 돌파',
    'summary': '카카오게임즈의 신작 모바일 RPG가 출시 전 사전예약자 100만 명을 돌파하며 흥행 기대감을 높이고 있다.',
    'pub_date': '2026-02-23T11:00:00',
    'path': 'A1',
    'stock_name': '카카오게임즈',
    'stock_change': '+6.1%',
    'stock_up': true,
  ...
  {
    'news_id': 213900,
    'title': '현대건설, 중동 대형 건설 프로젝트 수주 성공',
    'summary': '현대건설이 사우디아라비아 네옴시티 관련 대형 건설 프로젝트를 수주하며 해외 건설 시장에서의 경쟁력을 과시했다.',
    'pub_date': '2026-02-22T10:00:00',
    'path': 'A1',
    'stock_name': '현대건설',
    'stock_change': '+3.4%',
    'stock_up': true,
  ...
  {
    'news_id': 213800,
    'title': 'LG전자, 올레드 TV 글로벌 점유율 70% 돌파',
    'summary': 'LG전자의 올레드 TV가 글로벌 시장에서 70% 이상의 점유율을 기록하며 프리미엄 TV 시장을 압도하고 있다.',
    'pub_date': '2026-02-20T09:00:00',
    'path': 'A1',
    'stock_name': 'LG전자',
    'stock_change': '+1.6%',
    'stock_up': true,
  ...
  {
    'news_id': 213700,
    'title': '코스닥, 바이오주 약세에 700선 하회… 투자심리 위축',
    'summary': '코스닥 지수가 바이오 관련 주식들의 약세로 700선을 하회하며 투자 심리가 위축되고 있다.',
    'pub_date': '2026-02-18T16:30:00',
    'path': 'A2',
    'stock_name': '셀트리온',
    'stock_change': '-1.4%',
    'stock_up': false,
  ...
  {
    'news_id': 213650,
    'title': 'KT, AI 기반 네트워크 자동화 솔루션 출시',
    'summary': 'KT가 인공지능 기반의 네트워크 자동화 솔루션을 출시하며 B2B 시장에서의 경쟁력 강화에 나섰다.',
    'pub_date': '2026-02-17T10:00:00',
    'path': 'A1',
    'stock_name': 'KT',
    'stock_change': '+1.2%',
    'stock_up': true,
  ...
  {
    'news_id': 213600,
    'title': '한화오션, 미 해군 함정 MRO 사업 수주 추진',
    'summary': '한화오션이 미국 해군 함정의 유지보수 사업 수주를 추진하며 방산 분야에서의 글로벌 영향력 확대에 나서고 있다.',
    'pub_date': '2026-02-16T11:30:00',
    'path': 'A1',
    'stock_name': '한화오션',
    'stock_change': '+7.3%',
    'stock_up': true,
  ...
  {
    'news_id': 213500,
    'title': '신한금융, 베트남 금융 시장 공략 강화',
    'summary': '신한금융그룹이 베트남 현지 금융 서비스를 확대하며 동남아시아 금융 시장에서의 입지 강화에 나서고 있다.',
    'pub_date': '2026-02-14T14:00:00',
    'path': 'A1',
    'stock_name': '신한금융',
    'stock_change': '+1.7%',
    'stock_up': true,
  ...
  {
    'news_id': 213450,
    'title': '넷마블, 해외 게임 인수로 글로벌 IP 강화',
    'summary': '넷마블이 해외 유명 게임사 인수를 통해 글로벌 게임 IP 포트폴리오를 강화하며 국제 경쟁력 제고에 나서고 있다.',
    'pub_date': '2026-02-13T10:00:00',
    'path': 'A2',
    'stock_name': '넷마블',
    'stock_change': '-0.9%',
    'stock_up': false,
  ...
  {
    'news_id': 213200,
    'title': '메리츠금융, 역대 최대 실적 경신… 주주환원 확대',
    'summary': '메리츠금융그룹이 역대 최대 실적을 경신하며 배당과 자사주 매입 등 주주환원 정책을 대폭 확대하기로 결정했다.',
    'pub_date': '2026-02-08T09:30:00',
    'path': 'A1',
    'stock_name': '메리츠금융',
    'stock_change': '+3.2%',
    'stock_up': true,
  ...
  {
    'news_id': 213100,
    'title': '삼성물산, 패션·리조트 부문 실적 개선으로 주가 상승',
    'summary': '삼성물산의 패션과 리조트 부문 실적이 크게 개선되며 주가가 상승세를 이어가고 있다.',
    'pub_date': '2026-02-06T10:30:00',
    'path': 'A1',
    'stock_name': '삼성물산',
    'stock_change': '+2.1%',
    'stock_up': true,
